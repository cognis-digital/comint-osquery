#!/usr/bin/env sh
# Universal installer for comint-osquery. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/comint-osquery.git"
echo "Installing comint-osquery ..."
...
echo "Done. Run: comint-osquery --help"
