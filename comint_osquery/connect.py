"""Native cognis-connect emit for comint-osquery — forward findings to any platform.

Maps comint-osquery's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    comint-osquery ... --format json | comint-osquery-emit --to stix
    comint-osquery-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
...
SOURCE = "comint-osquery"


def map_record(rec: dict) -> dict:
    """Tailor a comint-osquery record toward the Finding contract before normalize().
